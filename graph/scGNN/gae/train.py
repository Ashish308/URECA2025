...
from utils import gat_dataloader, mask_test_edges, preprocess_graph, get_roc_score
...
def gae_for(args):
    ...
    adj, features, y_test, tx, ty, test_maks, true_labels = gat_dataloader(args.dataset_str)
